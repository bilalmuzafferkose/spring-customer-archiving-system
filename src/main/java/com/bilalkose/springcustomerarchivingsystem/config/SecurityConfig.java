...
import com.bilalkose.springcustomerarchivingsystem.filter.JwtAuthenticationFilter;
import com.bilalkose.springcustomerarchivingsystem.service.UserDetailsImpl;
        ...
        return http
                ...
                .authorizeHttpRequests(
                        req->req.requestMatchers(mvcRequestBuilder.pattern("/register/**")).permitAll()
                                ...
                                .requestMatchers(mvcRequestBuilder.pattern("/v1/customer/**")).hasAuthority("ADMIN")
                                .requestMatchers(mvcRequestBuilder.pattern("/v1/file/**")).hasAuthority("ADMIN")
                                .anyRequest()
                                .authenticated()
